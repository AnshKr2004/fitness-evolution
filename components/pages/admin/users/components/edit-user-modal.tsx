      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <form onSubmit={handleSubmit} className="grid gap-4 py-4">
          ...
          <div className="grid gap-2">
            ...
            <Select value={membership || "None"} onValueChange={(value: "BASIC" | "PREMIUM" | "None") => setMembership(value === "None" ? null : value)}>
          ...
          <div className="flex justify-end gap-3">
            ...
            <Button type="submit" className="bg-blue-600 dark:bg-blue-700">Update User</Button>
          </div>
        </form>
      </DialogContent>
    </Dialog>
